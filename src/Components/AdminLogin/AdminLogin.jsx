    ...
    <div className="flex flex-col gap-4 items-center justify-center min-h-screen bg-gray-900 p-4">
      ...
      Welcome to Admin Dashboard
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="relative w-full px-6 py-3 cursor-pointer text-white font-semibold rounded-full bg-gray-900 border-2 border-orange-950 shadow-[0_0_10px_rgba(255,165,0,0.6)] hover:shadow-[0_0_20px_rgba(255,165,0,1)] transition-all duration-300 ease-in-out"
          >
            Login
          </button>
        </form>
