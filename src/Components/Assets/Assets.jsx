...
const ModelViewer = ({ modelUrl, modelHeight, rotation, cameraPosition }) => {
  ...
  return (
    ...
    <div className="relative w-full bg-white shadow-lg rounded-lg flex items-center justify-center mb-0">
      ...
      <div className="relative w-full" style={{ height: modelHeight }}>
        ...
        <Canvas camera={{ position: cameraPosition, fov: 50 }}>
          ...
          <Suspense fallback={null}>
            ...
            {model && <primitive object={model} rotation={rotationMap[view]} scale={1} />}
        ...
        {loading && (
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-gray-900 bg-opacity-80 text-white text-xl">
      ...
      <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 flex space-x-4 bg-gray-900 p-2 rounded-lg">

        {Object.keys(rotationMap).map((key) => (

          <button key={key} onClick={() => handleViewChange(key)} className="bg-gray-700 text-white p-2 rounded">
...
<div className="relative flex flex-col lg:flex-row items-start justify-between gap-8 p-6">
  <div className="w-full lg:w-2/3 flex flex-col items-start">
    <ModelViewer modelUrl={asset.modelUrl} scale={[2, 2, 2]} rotation={asset.rotation} modelHeight={modelHeight} cameraPosition={cameraPosition} />
  ...
  <div className="w-full lg:w-1/3 flex flex-col justify-start" ref={detailsRef}>
    <div className="bg-gray-800 p-6 rounded-lg shadow-md w-full text-center">
      <h1 className="text-2xl font-semibold text-white mb-2">{title}</h1>
      <div className="text-base text-gray-300 leading-snug">
