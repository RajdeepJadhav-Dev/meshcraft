...
<div
              key={index}
              className={`relative min-w-[60px] overflow-hidden m-2 border bg-cover bg-center rounded-[50px] shadow-md cursor-pointer transition-all duration-100 ease-in-out ${
                activeIndex === index
