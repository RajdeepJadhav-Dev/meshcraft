        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md ml-5 mr-5">
            <div className="bg-gray-900 py-8 px-4 shadow sm:rounded-lg sm:px-10">
                <form className="space-y-6" onSubmit={handleSubmit} method="POST">
                    ...
                    <Input id="confirm-password" label="Confirm Password" type="password" autoComplete="current-password"  value={formData.confirmPassword} onChange={handleChange}/>
                    <div>
                        <button
                            type="submit"
                ...
                <div className="text-sm text-center text-white mt-4">
                    <p>
                        ...
                        <Link to="/login" className="font-bold text-gray-400 hover:text-gray-500">
                            Login
                        </Link>
                    </p>
                </div>
